...
<x-ui.card>
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-start gap-3 mb-4">
        <div class="d-flex gap-3">
            <div class="support-chat-icon rounded-circle d-flex align-items-center justify-content-center flex-shrink-0">
    ...
    <div id="{{ $chatDomId }}-messages" class="support-chat-log d-flex flex-column gap-2 mb-4">
        @forelse ($preparedMessages as $item)
            <div class="d-flex {{ $item['is_own'] ? 'justify-content-end' : 'justify-content-start' }}">
                <div
                    class="support-chat-bubble {{ $item['is_own'] ? 'support-chat-bubble-own' : 'support-chat-bubble-other' }}">
